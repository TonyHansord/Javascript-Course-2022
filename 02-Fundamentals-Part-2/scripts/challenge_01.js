...
const calcAvg = (score1, score2, score3) => Math.round((score1 + score2 + score3) / 3);
...
function declareWinnerA(teamOneAvg, teamTwoAvg)
{
    ...
    {
        console.log(`Winners are Dolphins ${teamOneAvg} vs. ${teamTwoAvg}`);
    }
    else if(teamTwoAvg > (teamOneAvg * 2))
    {
        console.log(`Winners are Koalas ${teamTwoAvg} vs. ${teamOneAvg}`);
    }
    else 
    {
